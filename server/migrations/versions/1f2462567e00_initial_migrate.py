...
Revision ID: 1f2462567e00
Revises: 
Create Date: 2024-04-17 18:03:33.835104
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['product_id'], ['products.id'], name=op.f('fk_listings_product_id_products')),
